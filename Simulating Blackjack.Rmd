...
```{r}
# Each simulation took me around 2 minutes to run
# There are three simulations below
# So if you run this chunk, expect to wait roughly 6 minutes
...
kable(list(cis_2, 
           cis_1 %>% 
             remove_rownames(),
           cis_3),
      caption = 'Strategies: Simplified Basic Strategy, Basic Strategy, Mimic Dealer (bottom)',
      booktabs = TRUE,
      valign = 't', 
      linesep = "") %>% 
  kable_paper() %>% 
