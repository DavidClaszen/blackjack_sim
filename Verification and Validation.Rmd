...
Given a set of test data, the resulting calculated values should be identical.
...
test_1 <- replicate(10000, play_game(num_players = 1, initial_bet = 1, manual = FALSE, S_17 = TRUE, logic_board = lb_1))
test_2 <- replicate(10000, play_game(num_players = 1, initial_bet = 1, manual = FALSE, S_17 = TRUE, logic_board = lb_1))
